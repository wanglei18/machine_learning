...
with tf.Session() as sess:
    ...
    d = {'wink':0, 'leftlight':1, 'happy':2, 'normal':3,
        'rightlight':4, 'noglasses':5, 'surprised':6, 'centerlight':7,
        'sad':8, 'sleepy':9, 'glasses':10}
    m, n1, n2 = images.shape
    images = images.reshape(m,-1)
    subjects = np.array([d[s] for s in subjects])
