...
with tf.Session() as sess:
    saver.restore(sess, "./autoencoder_face_model/autoencoder_face.ckpt")
    reconstruct = sess.run(decoder_outputs, feed_dict = {X: X_train})
    reconstruct = reconstruct.reshape(-1, n1, n2)
    plt.figure(1)
